...
from hermes_core.memory_manager import sanitize_context
from hermes_core.message_sanitization import _sanitize_surrogates
from hermes_core.skill_commands import (
    SKILL_EXCERPT_JOINT,
    SKILL_SCAFFOLD_SQL_LIKE,
    describe_skill_invocation,
)
from hermes_core.hermes_constants import get_hermes_home
from hermes_core.sqlite_runtime import (
    is_sqlite_wal_reset_vulnerable as _is_sqlite_wal_reset_vulnerable,
)
from typing import Any, Callable, Dict, List, Optional, Tuple, TypeVar

from hermes_core.hermes_state_common import (  # noqa: F401  (re-exported for back-compat)
    _BRANCH_CHILD_SQL,
...
from hermes_core.hermes_state_portability import SessionPortabilityMixin
from hermes_core.hermes_state_schema import SessionSchemaMixin
from hermes_core.hermes_state_search import SessionSearchMixin
...
def resolve_journal_mode() -> str:
    ...
    """
    try:
        from hermes_core.config import load_config_readonly
...
def apply_database_pragmas(
    ...
    *,
    ...
    try:
        ...
        from hermes_core.config import cfg_get, load_config_readonly
...
def _backup_db_file(db_path: Path) -> Optional[Path]:
    ...
    try:
        from hermes_core.sqlite_safe_read import has_live_connection
    except ImportError:
...
def _connect_tracked_db(path, tracking_path=None, **kwargs):
    ...
    """
    try:
        from hermes_core.sqlite_safe_read import connect_tracked
    except ImportError:
        logger.debug(
...
def is_zeroed_state_db(
    ...
    """
    try:
        from hermes_core.backup import is_zeroed_sqlite_file
    ...
    if size <= 0:
        return False
    from hermes_core.sqlite_safe_read import read_header_bytes_preopen
    ...
    def _rows_to_conversation(
        ...
        *,
        ...
        if repair_alternation and messages:
            ...
            from hermes_core.agent_runtime_helpers import repair_message_sequence
