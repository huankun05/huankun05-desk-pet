...
from hermes_core.hermes_constants import get_config_path, get_hermes_home
...
def setup_logging(
    ...
    *force* is ``True``.
    ...
    from hermes_core.redact import RedactingFormatter
...
class _ManagedRotatingFileHandler(RotatingFileHandler):
    ...
    def __init__(self, *args, **kwargs):
        from hermes_core.config import is_managed
...
def _read_logging_config():
    ...
    try:
        ...
        try:
            from hermes_core.config import read_raw_config as _rrc
            cfg = _rrc() or {}
        except Exception:
