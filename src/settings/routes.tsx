...
const pageComponentLoaders: Record<string, () => Promise<{ default: ComponentType }>> = {
  ...
  '/settings/chat/modes': () => import('./pages/chat/ChatModesPage'),
  ...
  '/settings/memory/rules': () => import('./pages/memory/RulesPage'),
  '/settings/memory/data': () => import('./pages/memory/DataPage'),
  '/settings/memory/backup': () => import('./pages/memory/BackupPage'),
  '/settings/memory/growth': () => import('./pages/memory/GrowthPage'),
...
export const settingsTree: SettingsEntry[] = [
  {
    ...
    children: [
      ...
      },
      {
        title: '角色外观',
        subtitle: 'Display',
        description: '镜像翻转、显示与隐藏',
        icon: 'solar:mirror-bold-duotone',
        settingsEntry: true,
        order: 4,
        path: '/settings/appearance/display',
      },
      {
        title: '窗口与性能',
  ...
  },
  {
    title: '聊天',
    subtitle: 'Chat',
    description: '聊天窗口的外观、输入、语音、模式与会话数据',
    ...
    children: [
      ...
      },
      {
        title: '模式',
        subtitle: 'Modes',
        description: '工作模式/聊天模式切换',
        icon: 'solar:settings-bold-duotone',
        settingsEntry: true,
        order: 3,
        path: '/settings/chat/modes',
      },
      {
        title: '会话与数据',
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        settingsEntry: true,
        order: 2,
        path: '/settings/memory/rules',
      },
      {
        title: '记忆查看',
        subtitle: 'View',
        description: '查看对话、事实、偏好',
      ...
      },
      {
        title: '备份与恢复',
        subtitle: 'Backup',
        description: '自动 / 手动备份与还原',
        icon: 'solar:cloud-upload-bold-duotone',
        settingsEntry: true,
        order: 6,
        path: '/settings/memory/backup',
      },
      {
        title: '成长记忆',
        subtitle: 'Growth Memory',
        description: '桌宠自学习的用户记忆',
        icon: 'solar:graph-new-bold-duotone',
        settingsEntry: true,
        order: 7,
        path: '/settings/memory/growth',
      },
    ],
  },
  {
