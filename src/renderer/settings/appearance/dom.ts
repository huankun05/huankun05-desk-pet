...
export const characterDropdown = document.getElementById("character-dropdown") as HTMLElement;
export const characterDropdownTrigger = document.getElementById("character-dropdown-trigger") as HTMLButtonElement;
export const characterDropdownValue = document.getElementById("character-dropdown-value") as HTMLElement;
export const characterDropdownPanel = document.getElementById("character-dropdown-panel") as HTMLElement;
