...
export const IPC = {
  ...
  HERMES_GET_SETTINGS: "hermes:get-settings",
  HERMES_SAVE_SETTINGS: "hermes:save-settings",
  HERMES_GENERATE_KEY: "hermes:generate-key",
  HERMES_WRITE_ENV: "hermes:write-env",
  ...
  STORAGE_SET_USER_DATA_DIR: "storage:set-user-data-dir",
  STORAGE_GET_LOCATION: "storage:get-location",
  STORAGE_LIST_BACKUPS: "storage:list-backups",
  STORAGE_CREATE_BACKUP: "storage:create-backup",
  STORAGE_AUTO_BACKUP: "storage:auto-backup",
